...
async def help(client, m: Message):
    await m.delete()
    HEPZ = f"""
<b>- مـرحبا {m.from_user.mention}!

🛠 هذه هي قائمـة اوامر السـورس

- أوامر المستخدمين: 
• {HNDLR}اغنية [عنوان الأغنية | رابط يوتيوب | الرد على ملف الاغنية] - لتشغيل أغنية في المكالمه
• {HNDLR}فيديو [عنوان الأغنية | رابط يوتيوب | الرد على الفيديو] - لتشغيل فيديو في المكالمة
• {HNDLR}القائمة  - لعرض قائمة التشغيل الحالية
• {HNDLR}بنك - لعرض سرعه النت للبوت
• {HNDLR}الاوامر - لعرض اوامر سورس ميوزك جمثون

- أوامر المشرفين  : 
• {HNDLR}استئناف - لمواصلة تشغيل الاغنيه أو الفيديو المتوقف
• {HNDLR}ايقاف - لإيقاف تشغيل أغنية أو مقطع فيديو مؤقتًا
• {HNDLR}تخطي - لتخطي الاغنية أو الفيديو الحالي وتشغيل ما بعده
• {HNDLR}انهاء - لإنهاء التشغيل</b>
"""
    await m.reply(HEPZ)
...
🤖  اختصاص هذا البوت لتشغيل اغاني او مقاطع الفيديو في المكالمات الصوتية
